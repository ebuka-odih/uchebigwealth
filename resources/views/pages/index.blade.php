    ...
    <div class="section section-padding blog-section bg-color-01">
        ...
        <div class="container">
            ...
            <div class="blog-wrapper">
                ...
                <img class="shape-02" src="assets/images/round.png" alt="shape">

                <div class="row">
                    <div class="col-lg-6">

                        <!-- Blog video Start -->
                        <div class="blog-video" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="blog-items">
                            ...
                            <!-- Single Blog Start -->
                            <div class="single-blog" data-aos="fade-up" data-aos-delay="300">
                                <div class="shape"></div>
                                <ul class="meta">
                                    <li><i class="icofont-ui-user"></i> <a href="#">Kiana Jewett</a></li>
                                    <li><i class="icofont-ui-calendar"></i> 15 Feb, 2021</li>
                                </ul>
                                <h2 class="title"><a href="blog-details.html">Ultimate guide on how to start your startup company.</a></h2>
                                <p>Lorem Ipsum is simply dummy text the printing and typesetting industry the industry sandard.</p>
                                <a href="blog-details.html" class="btn">Details +</a>
                            </div>
                            <!-- Single Blog End -->
